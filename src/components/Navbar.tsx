...
export default function Navbar() {
  ...
  useEffect(() => {
    const sectionIds = ['home', 'about', 'projects', 'skills', 'certifications', 'profiles', 'contact'];
                  ...
                  {navLinks.filter(l => l.label !== 'Contact').map((link) => {
                    ...
                    return (
                      <motion.a
                        ...
                        className={`relative px-5 py-2.5 text-base font-semibold transition-all rounded-full hover:bg-zinc-100 ${
                      ...
                      >
                        ...
                        {isActive && (
                          <motion.span
                            layoutId="nav-active"
                            className="absolute bottom-1.5 left-5 right-5 h-0.5 bg-zinc-900 rounded-full"
            ...
            <AnimatePresence mode="wait">
              {showFullNav ? (
                <motion.a
                  ...
                  className="bg-zinc-900 text-white text-sm font-bold px-7 py-2.5 rounded-full hover:bg-zinc-800 transition-all hover:scale-105 active:scale-95 shadow-md shadow-zinc-200 whitespace-nowrap uppercase tracking-tight"
                >
                  Contact
                </motion.a>
              ) : (
